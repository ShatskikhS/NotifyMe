 ...
 * @param {import('../stores/fsStores.js').default} fsManager Store manager exposing `hasId` lookups against persisted records.
 * @returns {(req: import('express').Request, res: import('express').Response, next: import('express').NextFunction) => void} Express middleware that validates `req.params.id`.
 */
